package co.edu.udea.runtwebapp.persistence.exception;

import org.apache.log4j.Logger;

public class RuntWebAppPersistenceBusinessException extends Exception {
	...
	private static final Logger LOGGER = Logger
			.getLogger(RuntWebAppPersistenceBusinessException.class);

	/**
	 * Constante utilizada para realizar operaciones de serializaci&oacute;n y
	 * deserializaci&oacute;n de la instancia
	 * {@code RuntWebAppPersistenceBusinessException}, e igualmente, de todos
	 ...
	 * aplicaci&oacute;n.
	 */
	public RuntWebAppPersistenceBusinessException() {
		super();
		LOGGER.error("RuntWebAppPersistenceBusinessException: An error has happened during process.");
	}
	 ...
	 */
	public RuntWebAppPersistenceBusinessException(String message) {
		super(message);
		LOGGER.error("RuntWebAppPersistenceBusinessException: An error has happened during process."
				+ message);
	}
	 ...
	 *            ser lanzado.
	 */
	public RuntWebAppPersistenceBusinessException(Throwable cause) {
		super(cause);
		LOGGER.error(
				"RuntWebAppPersistenceBusinessException: An error has happened during process.",
				cause);
	}
