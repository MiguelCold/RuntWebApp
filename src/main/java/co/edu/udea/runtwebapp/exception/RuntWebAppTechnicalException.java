package co.edu.udea.runtwebapp.exception;
 ...
 */
public class RuntWebAppTechnicalException extends Exception{
	 ...
	 * aplicaci&oacute;n.
	 */
	public RuntWebAppTechnicalException() {
		super();
		LOGGER.error("RuntWebAppTechnicalException: An error has happened during process.");
	}
	 ...
	 */
	public RuntWebAppTechnicalException(String message) {
		super(message);
		LOGGER.error("RuntWebAppTechnicalException: An error has happened during process."
				+ message);
	}
	 ...
	 *            ser lanzado.
	 */
	public RuntWebAppTechnicalException(Throwable cause) {
		super(cause);
		LOGGER.error(
				"RuntWebAppTechnicalException: An error has happened during process.",
				cause);
	}
	 ...
	 *            ser lanzado.
	 */
	public RuntWebAppTechnicalException(String message, Throwable cause) {
		super(message, cause);
		LOGGER.error(
				"RuntWebAppTechnicalException: An error has happened during process.",
				cause);
